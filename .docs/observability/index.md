...
- Read the subdomain docs before changing stack lifecycle, emitted signals, query wrappers, or the executable acceptance workflow.

# Subdomains

- [acceptance](./acceptance.md): Consult when changing the executable README prompt suite, smoke-runner workflow, or how the repo proves logs, metrics, and traces end to end.
